...
app.config['UPLOAD_FOLDER'] = r'C:/Users/usham/Downloads/Face-Recognition-WebApp-master/Face-Recognition-WebApp-master/upload'
...
if __name__ == '__main__':
   app.run(host= '192.168.43.109', debug = True)
